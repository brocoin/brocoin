...
Contains files used to package brocoind/brocoin-qt
for Debian-based Linux systems. If you compile brocoind/brocoin-qt yourself, there are some useful files here.
...
### [RPM](/contrib/rpm) ###
RPM spec file for building brocoin-core on RPM based distributions
