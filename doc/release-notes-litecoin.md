Brocoin Core version 0.14.2 is now available from:
  ...
  <https://download.brocoin.org/brocoin-0.14.2.0/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/brocoin/brocoin/issues>

To receive security and update notifications, please subscribe to:

  <https://groups.google.com/forum/#!forum/brocoin-dev>
...
Brocoin Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in Brocoin Core 0.10.4) it has been disabled by default.
...
- http://testnet.brocointools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/brocoin/brocoin/blob/master/src/chainparams.cpp#L220).
...
Brocoin Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
The Alert System was disabled and deprecated in Brocoin Core 0.10.4 and removed in 0.13.2. 
...
here, originally written for Bitcoin but can also be used for Brocoin:
