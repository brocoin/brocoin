...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s brocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  brocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded brocoin transaction") + "\n" +
              "  brocoin-tx [options] -create [commands]   " + _("Create hex-encoded brocoin transaction") + "\n" +
              "\n";
